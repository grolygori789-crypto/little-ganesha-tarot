...
assert(index.includes('css/profile-home.css?v=0.5.0'));
assert(index.includes('js/profile-details.js?v=0.5.0'));
assert(index.indexOf('js/profile-details.js?v=0.5.0') < index.indexOf('js/app.js?v=0.5.0'));
assert(index.includes('BUILD 0.5.0'));
...
assert(app.includes("window.LGT_BUILD = '0.5.0'"));
...
assert(sw.includes("const BUILD = '0.5.0'"));
assert(sw.includes("url('css/profile-home.css?v=0.5.0')"));
assert(sw.includes("url('js/profile-details.js?v=0.5.0')"));

...
assert(index.includes('css/profile-home.css?v=0.4.9'));
assert(index.includes('js/profile-details.js?v=0.4.9'));
assert(index.indexOf('js/profile-details.js?v=0.4.9') < index.indexOf('js/app.js?v=0.4.9'));
assert(index.includes('BUILD 0.4.9'));
assert(!index.includes('0.4.8'));
...
assert(app.includes("window.LGT_BUILD = '0.4.9'"));
...
assert(sw.includes("const BUILD = '0.4.9'"));
assert(sw.includes("url('css/profile-home.css?v=0.4.9')"));
assert(sw.includes("url('js/profile-details.js?v=0.4.9')"));
assert(!sw.includes('0.4.8'));

...
assert(index.includes('css/profile-home.css?v=0.4.8'));
assert(index.includes('js/profile-details.js?v=0.4.8'));
assert(index.indexOf('js/profile-details.js?v=0.4.8') < index.indexOf('js/app.js?v=0.4.8'));
...
assert(app.includes("zodiac.textContent = `(${summary.zodiacLabel})`"));
...
assert(sw.includes("url('css/profile-home.css?v=0.4.8')"));
assert(sw.includes("url('js/profile-details.js?v=0.4.8')"));

(() => {
  ...
  setLanguage(language); applyMotionMode(); syncAudioUI(); updateSettingsUI(); scheduleProfileRollover(); window.LGT_BUILD = '0.5.1'; setTimeout(revealTitle, isReducedMotion() ? 1200 : 2600);
})();

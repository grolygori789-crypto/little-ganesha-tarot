(() => {
  ...
  setLanguage(language); applyMotionMode(); syncAudioUI(); updateSettingsUI(); scheduleProfileRollover(); window.LGT_BUILD = '0.5.4'; setTimeout(revealTitle, isReducedMotion() ? 1200 : 2600);
})();

(() => {
  ...
  setLanguage(language); applyMotionMode(); syncAudioUI(); updateSettingsUI(); scheduleProfileRollover(); window.LGT_BUILD = '0.13.0'; setTimeout(revealTitle, isReducedMotion() ? 1200 : 2600);
})();

...
const APP_SHELL = [
  url('./'),
  url('index.html'),
  url('manifest.webmanifest?v=0.6.2'),
  url('css/app.css?v=0.6.2'),
  url('css/reading.css?v=0.6.2'),
  url('css/three-card-viewer.css?v=0.6.2'),
  url('css/golden-path.css?v=0.6.2'),
  url('css/profile-home.css?v=0.6.2'),
  url('js/pwa.js?v=0.6.2'),
  url('js/audio.js?v=0.6.2'),
  url('js/profile-details.js?v=0.6.2'),
  url('js/app.js?v=0.6.2'),
  url('js/reading-content.js?v=0.6.2'),
  url('js/reading-engine.js?v=0.6.2'),
  url('js/reading-day.js?v=0.6.2'),
  url('js/reading-export.js?v=0.6.2'),
  url('js/deck-ritual.js?v=0.6.2'),
  url('js/three-narrative.js?v=0.6.2'),
  url('js/question-guard.js?v=0.6.2'),
  url('js/ask-content.js?v=0.6.2'),
  url('js/question-analyzer.js?v=0.6.2'),
  url('js/question-contract.js?v=0.6.2'),
  url('js/ask-context.js?v=0.6.2'),
  url('js/ask-semantic.js?v=0.6.2'),
  url('js/ask-storage.js?v=0.6.2'),
  url('js/reading-ui.js?v=0.6.2'),
  url('js/ask-export.js?v=0.6.2'),
  url('js/ask-ui.js?v=0.6.2'),
  url('js/three-export.js?v=0.6.2'),
  url('js/three-storage.js?v=0.6.2'),
  url('js/three-ui.js?v=0.6.2'),
  url('js/three-card-viewer.js?v=0.6.2'),
  url('js/golden-narrative.js?v=0.6.2'),
  url('js/golden-storage.js?v=0.6.2'),
  url('js/golden-export.js?v=0.6.2'),
  url('js/golden-ui.js?v=0.6.2'),
  url('js/golden-card-viewer.js?v=0.6.2'),
